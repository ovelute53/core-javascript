...
// console창에서 first()를 읽게 되면 second 함수 자체를 내뱉는다
// second 안의 내용까지 뽑아내고 싶다면 first()() 실행문을 한번 더 붙여준다

const value = first();
// first 함수를 실행하게 되면 second 함수 본문을 반환하게 된다
// 그렇기 때문에 클로저를 설정해주게 되면 first 실행을 value라는 선언에 할당해주면 value()를 하게되면 second 함수의 값이 도출된다
